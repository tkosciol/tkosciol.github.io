...
The work will be carried out as a part of the Microbiome Immunity Project ([https://www.worldcommunitygrid.org/research/mip1/overview.do](https://www.worldcommunitygrid.org/research/mip1/overview.do)). There will also be multiple opportunities to work on projects related to the human microbiome analyses, especially in type-1 diabetes, and mental health (the gut-brain axis).
...
Please send an email with a subject line “PhD student” to [work@tomaszlab.org](mailto:work@tomaszlab.org) including: 
